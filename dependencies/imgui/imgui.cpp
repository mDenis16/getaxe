...
const char* ImGui::GetStyleColorName(ImGuiCol idx)
{
    ...
    case ImGuiCol_CheckboxActive: return "CheckboxActive";
    case ImGuiCol_CheckboxBackground: return "CheckboxBackground";
...
ImVec2 ImGui::CalcTextSize ( const char * text, float size, ImFont * font )
{
