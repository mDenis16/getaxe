...
public:
	const char* get_name( ) {
		return utilities::call_virtual< const char* ( __thiscall* )( decltype( this ) ) >( this, 0 )( this );
	}
	...
	i_material* find_material( const char* material_name, const char* texture_group_name, bool complain = true, const char* complain_prefix = nullptr ) {
		return utilities::call_virtual< i_material* ( __thiscall* )( decltype( this ), const char*, const char*, bool, const char* ) >( this, 84 )( this, material_name, texture_group_name, complain, complain_prefix );
	}

	int first_material( ) {
		return utilities::call_virtual< int( __thiscall* )( decltype( this ) ) >( this, 86 )( this );
	}

	int next_material( int handle ) {
		return utilities::call_virtual< int( __thiscall* )( decltype( this ), int ) >( this, 87 )( this, handle );
	}

	int invalid_material_handle( ) {
		return utilities::call_virtual< int( __thiscall* )( decltype( this ) ) >( this, 88 )( this );
	}

	i_material* get_material( int handle ) {
		return utilities::call_virtual< i_material* ( __thiscall* )( decltype( this ), int ) >( this, 89 )( this, handle );
	}

	IMatRenderContext* get_render_context( ) {
		return utilities::call_virtual< IMatRenderContext* ( __thiscall* )( decltype( this ) ) >( this, 115 )( this );
	}
