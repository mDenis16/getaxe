...
namespace ui {
	namespace menu {
		...
		void settings_menu ( object * main_window, object * sub_tab ) {
			...
			auto rage_window = new ui::child_window ( "", 100.f, 100.f, ImColor ( 255, 255, 255, 0 ), main_window, child_type::main_container ); rage_window->flex = flex_direction::block; rage_window->padding = 15;
			...
			main_tab = new ui::child_window ( "", 100.f, 78.0, ImColor ( 255, 24, 27, 0 ), rage_window, float_side::none, child_rounding, 15.f );
			...
			auto bottom_side = new ui::child_window ( "", 100.f, 15.0, ImColor ( 255, 214, 27, 0 ), rage_window, float_side::none, child_rounding, 15.f );
			...
			//
			auto left_bottom_side = new ui::child_window ( "", 45.f, 100.0f, ImColor ( 255, 24, 255, 255 ), bottom_side, child_type::normal, flags::align_left | flags::vertical_align_center | flags::position_absolute ); left_bottom_side->flags |= flags::no_bg_shadow; left_bottom_side->flags |= flags::no_background;
			{
				new ui::text_input ( left_bottom_side, "Config name", config_name, text_type::string, 80.f, 40.f );
				new ui::button ( "Create config", left_bottom_side, 80.f, 40.f, create_config );
			}

			auto right_bottom_side = new ui::child_window ( "", 45.f, 100.0f, ImColor ( 255, 255, 255, 255 ), bottom_side, child_type::normal, flags::align_right | flags::vertical_align_center | flags::position_absolute ); right_bottom_side->flags |= flags::no_bg_shadow; right_bottom_side->flags |= flags::no_background;
			{

				new ui::button ( "Refresh list", right_bottom_side, 80.f, 40.f, refresh_ext );
				new ui::button ( "Open folder", right_bottom_side, 80.f, 40.f, open_folder );
			}
		}
	}
}