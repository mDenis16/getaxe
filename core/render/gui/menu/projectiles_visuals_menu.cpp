...
namespace ui {
	namespace menu {
		...
		void projectiles_weapons_menu(object* main_window, sub_tab* sub_tab) {
			...
			auto& cfg = config.projectiles_visual;

			auto main_tab = new ui::child_window(GET_STR("Projectiles Assist"), 45.f, 50.f, ImColor(23, 24, 27, 255), visuals_window, float_side::none, child_rounding, 15.f);
...
;
				...
				new ui::checkbox(GET_STR("Grenade radius"), main_tab, cfg.grenade_radius);
;
				new ui::checkbox(GET_STR("Grenade indicator"), main_tab, cfg.grenade_radius_warning);
;
			}
...
;
	...
	CHAMS_MODEL_MAX
			...
			auto third_tab = new ui::child_window(GET_STR("Misc"), 45.f, 60.0, ImColor(23, 24, 27, 255), visuals_window, float_side::none, child_rounding, 15.f);
			{
				...
				new ui::checkbox(GET_STR("Grenade warning"),  third_tab, cfg.grenade_warning, cfg.out_of_pov_color);

				new ui::checkbox(GET_STR("Grenade path"),  third_tab, cfg.grenade_path, cfg.out_of_pov_color);
