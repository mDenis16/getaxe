...
namespace ui {
	namespace menu {
		...
		void inventory_changer_menu ( object * main_window, sub_tab * sub_tab ) {
			auto inventory_window = new ui::child_window ( GET_STR(""), 100.f, 100.f, ImColor(255, 255, 255, 0), main_window, child_type::main_container, flags::no_background); inventory_window->flex = flex_direction::automatic; inventory_window->padding = 15;
