...
namespace ui {
	...
	public:
		...
		void* value;
		std::string* text_val;
		SecureString* place_holder = nullptr;
		...
		text_input(object* parent, SecureString& place_holder, std::string& value, text_type _type, float percent_width, float percent_height) {
